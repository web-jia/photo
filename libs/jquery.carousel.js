...
;(function($){
    ...
    Caroursel.prototype = {
        ...
        setFirstPosition:function(){
            ...
            if($(window).width()>780){
                 this.prevBtn.css({"width":width+100 , "height":this.setting.height,"zIndex":Math.ceil(this.posterItems.size()/2)});
            this.nextBtn.css({"width":width+100 , "height":this.setting.height,"zIndex":Math.ceil(this.posterItems.size()/2)});
            }else{
